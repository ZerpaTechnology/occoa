"use strict";
// Transcrypt'ed from Python, 2018-01-21 23:25:19
function detalles () {
				...
				__init__: function (__all__) {
					...
					var Widget = __class__ ('Widget', [object], {
						...
						get add () {return __get__ (this, function (self, target, n) {
							...
							if (self._update) {
								...
								if (n == 1) {
									...
									$ (self.content (self)).append (target.target2);
								}
								else if (n == 3) {
									$ (self.content (self)).append (target.target3);
								}
								else if (n == 4) {
									$ (self.content (self)).append (target.target4);
								}
								else if (n == 5) {
									$ (self.content (self)).append (target.target5);
								}
							}
							else {
								target.py_update ();
						...
						get __update__ () {return __get__ (this, function (self) {
							...
							self.target2.html (self._html.format.apply (null, self.format2));
							self.target3.html (self._html.format.apply (null, self.format3));
							self.target4.html (self._html.format.apply (null, self.format4));
							self.target5.html (self._html.format.apply (null, self.format5));
							if (self.children != list ([])) {
								var __iterable0__ = enumerate (self.children);
								for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
									var __left0__ = __iterable0__ [__index0__];
